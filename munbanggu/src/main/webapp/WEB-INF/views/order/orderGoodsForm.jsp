		...
		if (payType == 'kakao') {
			...
			$.ajax({
				...
				success : function(data, textStatus) {
					...
					// 폼에 있는 인풋박스 데이터 변경
					//document.getElementsByName('성함')[0].속성 // name은 id와 다르게 배열을 반환
/* 					document.getElementsByName('ordr_idxx')[0].value = ordr_idxx ;
					...
					document.getElementsByName('responseMsg')[0].value = responseMsg ;
					document.getElementsByName('Ret_URL')[0].value = Ret_URL ; */
					
					//제이쿼리 $("input[name=ordr_idxx]").val(ordr_idxx);
					...
					/* $("input[name=pay_url]").val(pay_url); 견적서오타로 PC가 아니라 모바일  */ 
...
<body>
				...
				<tr>
					<c:forEach var="item" items="${myOrderList }">
						<td class="goods_image">
							<a href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id }"> <img width="75" alt="" src="${contextPath}/thumbnails.do?goods_id=${item.goods_id}&fileName=${item.goods_fileName}"> <input type="hidden" id="h_goods_id" name="h_goods_id" value="${item.goods_id }" /> <input type="hidden" id="h_goods_fileName" name="h_goods_fileName" value="${item.goods_fileName }" />
							</a>
						</td>
						<td>
							<h2>
			...
			<table>
				<tbody>
					<tr class="dot_line">
						...
						<td>
							<input type="radio" id="delivery_method" name="delivery_method" value="일반택배" checked>
							일반택배 &nbsp;&nbsp;&nbsp;
							<input type="radio" id="delivery_method" name="delivery_method" value="편의점택배">
							편의점택배 &nbsp;&nbsp;&nbsp;
							<input type="radio" id="delivery_method" name="delivery_method" value="해외배송">
							해외배송 &nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr class="dot_line">
						...
						<td>
							<input type="radio" name="delivery_place" onClick="restore_all()" value="기본배송지" checked>
							기본배송지 &nbsp;&nbsp;&nbsp;
							<input type="radio" name="delivery_place" value="새로입력" onClick="reset_all()">
							새로입력 &nbsp;&nbsp;&nbsp;
							<input type="radio" name="delivery_place" value="최근배송지">
							최근배송지 &nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr class="dot_line">
					...
					<tr class="dot_line">
						...
						<td>
							...
							<input size="10px" type="text" id="tel2" name="tel2" value="${orderer.tel2 }">
							-
					...
					<tr class="dot_line">
						...
						<td>
							...
							<a class="look_up_btn" href="javascript:execDaumPostcode()">우편번호검색</a> <br>
							<p>
								지번 주소:<br>
					...
					<tr class="dot_line">
						...
						<td>
							<input type="radio" id="gift_wrapping" name="gift_wrapping" value="yes">
							예 &nbsp;&nbsp;&nbsp;
							<input type="radio" id="gift_wrapping" name="gift_wrapping" checked value="no">
							아니요
						</td>
						</td>
						</tboby>
			...
			<table>
				<tbody>
					<tr class="dot_line">
						<td width=100>적립금</td>
						<td>
							<input name="discount_juklip" type="text" size="10" />
							원/1000원 &nbsp;&nbsp;&nbsp;
							<input type="checkbox" />
							모두 사용하기
						</td>
					...
					<tr class="dot_line">
						<td>예치금</td>
						<td>
							<input name="discount_yechi" type="text" size="10" />
							원/1000원 &nbsp;&nbsp;&nbsp;
							<input type="checkbox" />
							모두 사용하기
						</td>
					...
					<tr class="dot_line">
						<td>상품권 전환금</td>
						<td cellpadding="5">
							<input name="discount_sangpum" type="text" size="10" />
							원/0원 &nbsp;&nbsp;&nbsp;
							<input type="checkbox" />
							모두 사용하기
						</td>
					...
					<tr class="dot_line">
						<td>OK 캐쉬백 포인트</td>
						<td cellpadding="5">
							<input name="discount_okcashbag" type="text" size="10" />
							원/0원 &nbsp;&nbsp;&nbsp;
							<input type="checkbox" />
							모두 사용하기
						</td>
					...
					<tr class="dot_line">
						<td>쿠폰할인</td>
						<td cellpadding="5">
							<input name="discount_coupon" type="text" size="10" />
							원/0원 &nbsp;&nbsp;&nbsp;
							<input type="checkbox" />
							모두 사용하기
						</td>
		...
		<div class="detail_table">
			<table>
				<tbody>
					<tr>
						<td>
							<input type="radio" id="pay_method" name="pay_method" value="신용카드" onClick="fn_pay_card()" checked>
							신용카드 &nbsp;&nbsp;&nbsp;
							<input type="radio" id="pay_method" name="pay_method" value="제휴 신용카드" readonly>
							제휴 신용카드 &nbsp;&nbsp;&nbsp;<br>
							<input type="radio" id="pay_method" name="pay_method" value="실시간 계좌이체" readonly>
							실시간 계좌이체 &nbsp;&nbsp;&nbsp;
							<input type="radio" id="pay_method" name="pay_method" value="무통장 입금" readonly>
							무통장 입금 &nbsp;&nbsp;&nbsp;<br>
						</td>
					</tr>
					<tr>
						<td>
							<input type="radio" id="pay_method" name="pay_method" value="휴대폰결제" onClick="fn_pay_phone()" readonly>
							휴대폰 결제
							<!-- 		// 결제모듈 20230601 -->
							&nbsp;&nbsp;&nbsp;<br>
							<input type="radio" id="pay_method" name="pay_method" value="kakao">
							카카오페이(간편결제)<br>
							<input type="radio" id="pay_method" name="pay_method" value="naver_card">
							네이버페이(신용카드) &nbsp;&nbsp;&nbsp;
							<input type="radio" id="pay_method" name="pay_method" value="naver_point">
							네이버페이(포인트) &nbsp;&nbsp;&nbsp; <br>
							<input type="radio" id="pay_method" name="pay_method" value="페이나우(간편결제)" readonly>
							페이나우(간편결제) &nbsp;&nbsp;&nbsp;<br>
							<input type="radio" id="pay_method" name="pay_method" value="페이코(간편결제)" readonly>
							페이코(간편결제) &nbsp;&nbsp;&nbsp;<br>
						</td>
					</tr>
					<tr>
						<td>
							<input type="radio" id="pay_method" name="pay_method" value="직접입금">
							직접입금&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr id="tr_pay_card">
						<td>
							<strong>카드 선택</strong>:&nbsp;&nbsp;&nbsp; <select id="card_com_name" name="card_com_name">
							...
							</select> <br> <Br> <strong>할부 기간:</strong> &nbsp;&nbsp;&nbsp; <select id="card_pay_month" name="card_pay_month">
					...
					<tr>
						<td>
							<strong>카드번호 (-) 제외 : </strong>
						</td>
						<td>
							<input type="text" id="cardNo" name="cardNo" value="9490191412341234">
						</td>
					</tr>
					<tr>
						<td>
							<strong>카드유효기간 YY : </strong>
						</td>
						<td>
							<input type="text" id="expireYear" name="expireYear" value="19">
						</td>
					</tr>
					<tr>
						<td>
							<strong>카드유효기간 MM : </strong>
						</td>
						<td>
							<input type="text" id="expireMonth" name="expireMonth" value="05">
						</td>
					</tr>
					<tr>
						<td>
							<strong>생년월일/사업자번호 : </strong>
						</td>
						<td>
							<input type="text" id="birthday" name="birthday" value="900915">
						</td>
					</tr>
					<tr>
						<td>
							<strong>카드비밀번호 앞 2자리 : </strong>
						</td>
						<td>
							<input type="text" id="cardPw" name="cardPw" value="00">
						</td>
					</tr>
					<tr>
						<td>
							<strong>할부기간 0~24 : </strong>
						</td>
						<td>
							<input type="text" id="quota" name="quota" value="9">
						</td>
					</tr>

					<tr id="tr_pay_phone" style="visibility: hidden">
						<td>
							<strong>휴대폰 번호 입력: <strong> <input type="text" size="5" value="" id="pay_order_tel1" name="pay_order_tel1" />- <input type="text" size="5" value="" id="pay_order_tel2" name="pay_order_tel2" />- <input type="text" size="5" value="" id="pay_order_tel3" name="pay_order_tel3" />
						</td>
					</tr>
				</tbody>
			</table>
	...
	<br>
	<center>
		<br> <br> <a href="javascript:fn_show_order_detail();"> <img width="125" alt="" src="${contextPath}/resources/image/btn_gulje.jpg">
		</a> <a href="${contextPath}/main/main.do"> <img width="75" alt="" src="${contextPath}/resources/image/btn_shopping_continue.jpg">
		</a>
		...
		<div id="layer" style="visibility: hidden">
			...
			<div id="popup_order_detail">
					...
					<table>
						<tbody align=left>
							...
							<tr>
								...
								<td>
									<p id="p_orderer_name">주문자 성함</p>
								</td>
							</tr>
							<tr>
								<td width=200px>받는사람:</td>
								<td>
									<p id="p_receiver_name">받는사람성함</p>
								</td>
							</tr>
							<tr>
				...
				<form name="order_info" method="post" accept-charset="euc-kr">
					...
					<input type="hidden" name="kakaopay_direct" value=”${kakaopay_direct}”>
					<input type="hidden" name="naverpay_direct" value=”${naverpay_direct}”>
...
alert( "인증완료" );
if (frm.kakaopay_direct.value == "Y"){
	frm.action = "${contextPath}/payment/kakao/pay.do";
}else{
	frm.action = "${contextPath}/payment/naver/pay.do";
}
