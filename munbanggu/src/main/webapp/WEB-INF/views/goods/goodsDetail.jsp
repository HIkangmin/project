		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td class="fixed">주문 후 2~3일 소요</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="fixed">${goods.goods_publisher}</td>
				</tr>
			</tbody>
		</table>
		<ul>
	...
	<div id="container">
		...
		<div class="tab_container">
			...
			<div class="tab_content" id="tab3">
				<form action="${contextPath}/customer/qnaWrite.do" method="post">
				<input type="hidden" name="goods_id" value="${goods.goods_id}">
				<input type="hidden" name="goods_title" value="${goods.goods_title}">
