...
<div class="tab_container">
	...
	<div class="tab_container" id="container">
		<ul class="tabs">
			...
			<li><a href="#tab3">상품제조사소개</a></li>
			 -->
			<li><a href="#tab4">상품소개</a></li>
			<!-- 
			<li><a href="#tab5">판매처 상품 평가</a></li>
		...
		<div class="tab_container">
			...
			<tr type="hidden" >
				<td >제품 총 페이지수</td>
				<td> -->
				<input type="hidden" name="goods_total_page" type="text" size="40" value ="" />
				<!-- </td>
			</tr>
			 -->
			<!-- <tr type="hidden" >
				<td >ISBN</td>
				<td > -->
				<input type="hidden" name="goods_isbn" type="text" size="40" value ="" />
				<!-- </td>
			</tr> -->
			<tr>
				<td >제품 배송비</td>
				<td><input name="goods_delivery_price" type="text" size="40" value="3000" /></td>
			</tr>
			<tr>
				<td >제품 수령일</td>
			...
			<div class="tab_content" id="tab2" type="hidden" >
				<H4>책목차</H4>
				<table>	
				 <tr  >
					<td >책목차</td>
					<td><textarea  rows="100" cols="80" name="goods_contents_order" value = ""></textarea></td>
				</tr>
				</table>	
			</div>
			<div class="tab_content" id="tab3" type="hidden" >
				<H4>제품 제조사 소개</H4>
				 <table>
  				 <tr>
					<td>제품 제조사 소개</td>
					<td><textarea  rows="100" cols="80" name="goods_writer_intro" value = "" ></textarea></td>
			    </tr>
			   </table>
			</div>
			...
			<div class="tab_content" id="tab5" type="hidden" >
				<H4>판매처 제품 평가</H4>
				<table>
				 <tr>
					<td>판매처 제품 평가</td>
