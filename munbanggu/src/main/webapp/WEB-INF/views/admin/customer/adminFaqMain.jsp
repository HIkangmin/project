...
<jsp:include page="/WEB-INF/views/common/viewPageTopSearchTable.jsp" flush="false">
	...
	<jsp:param name="type_tags_streams" value="faq_id,faq_title,faq_content,faq_date,member_id"/>
	<jsp:param name="type_captions_streams" value="번호,글제목,내용,작성 날짜,작성자"/>
	<jsp:param name="uri" value="${contextPath}/admin/customer/adminFaqMain.do"/>
</jsp:include>
	    ...
	    <div class="board-buttondiv">
		    ...
		    <div>
	<form action="deleteFaq.do"  method="post" id="admindelete"></form>		    
...
<jsp:include page="/WEB-INF/views/common/tableBottomPagination.jsp" flush="false">
	...
	<jsp:param name="uri" value="${contextPath}/admin/customer/adminFaqMain.do"/>
		            ...
		            <tr>
		                ...
		                <!-- <td class="noticeAdmin-title">삭제</td> -->
		            </tr>
		            
		            
		            <c:forEach var="faq" items="${ selectList }">
		            <tr>
		                <td class="noticeAdmin-td1"><input type="checkbox" name="faq_id" value="${ faq.faq_id }"></td>
					...
					<c:set var="dateVar" value="${ faq.faq_date }" />
					<fmt:formatDate value="${dateVar}" pattern="yyyy-MM-dd" /></td>
					<td ><a class="look_up_btn" href="deleteFaq.do?faq_id=${ faq.faq_id }"> 삭제 </a></td>
		            </tr>
		            </c:forEach> --%>
