...
<script>
function fn_modify_company_info(company_id,mod_type){
	var value="";

	 alert("mod_type:"+company_id + mod_type);
		var frm_mod_company=document.frm_mod_company;
		if(mod_type=='license_date'){
			value=frm_mod_company.license_date.value;

		}else if(mod_type=='company_birth'){
		...
		$.ajax({
			...
			url : "http://localhost:8081/munbanggu/admin/company/addCompanyInfo.do",
			data : {
...
function fn_delete_company(company_id ,del_yn){
	var frm_mod_company=document.frm_mod_company;
    ...
    frm_mod_company.appendChild(i_company_id);
    frm_mod_company.appendChild(i_del_yn);
    frm_mod_company.method="post";
    frm_mod_company.action="/munbanggu/admin/company/deletecompany.do";
    frm_mod_company.submit(); 
}
...
<body>
	<h3>거래처 상세 정보</h3>
<form name="frm_mod_company" action="${contextPath}/munbanggu/admin/company/addCompanyInfo.do" method="post"  >	
	<div id="detail_table">
		<table>
			<tbody>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td>
					  ...
					  <br>
					  <p> 
					   지번 주소:<br><input type="text" id="roadAddress"  name="roadAddress" size="55" value="${company_info.roadAddress }"><br><br>
					  도로명 주소: <input type="text" id="jibunAddress" name="jibunAddress" size=55 value="${company_info.jibunAddress }"><br><br>
					  나머지 주소: <input type="text"  name="namujiAddress" size="55" value="${company_info.namujiAddress }" />
