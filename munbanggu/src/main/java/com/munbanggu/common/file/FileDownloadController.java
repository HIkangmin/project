package com.munbanggu.common.file;
...
public static final String CURR_IMAGE_REPO_PATH = BaseRepoPath.getImagePath();
	...
	protected void thumbnails(@RequestParam("fileName") String fileName,
		...
		System.out.println( "image.getAbsolutePath()" + image.getAbsolutePath() );
	      Path currentPath = Paths.get("");
	        ...
	        System.out.println("현재 작업 경로: " + System.getProperties());
	        System.out.println("현재 작업 경로: " + System.getProperty("wtp.deploy") );
	        System.out.println("현재 작업 경로: " + System.getProperty("wtp.deploy").split(".metadata")[0].replace('\\', '/') );
	...
	//Q&A
		...
		protected void qnadownload(@RequestParam("fileName") String fileName,
				                 ...
				                 HttpServletResponse response) throws Exception {
			OutputStream out = response.getOutputStream();
			String filePath = CURR_IMAGE_REPO_PATH + "/" + qna_id + "/" + fileName;
			File image=new File(filePath);
