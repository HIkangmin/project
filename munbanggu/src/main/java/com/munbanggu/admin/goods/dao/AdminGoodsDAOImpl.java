package com.munbanggu.admin.goods.dao;
...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
    ...
    public int countSelectNewGoodsList( Map condMap ) throws DataAccessException {
        int count = sqlSession.selectOne("mapper.admin.goods.countSelectNewGoodsList" , condMap) ;
        return count;
    }
