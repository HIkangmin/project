package com.munbanggu.admin.order.dao;
...
public class AdminOrderDAOImpl  implements AdminOrderDAO{
	...
	public int countSelectNewOrderList( Map condMap ) throws DataAccessException {
		int count = sqlSession.selectOne("mapper.admin.order.countSelectNewOrderList" , condMap) ;
		return count;
	}
