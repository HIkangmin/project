...
public interface MyPageController {
	...
	public ModelAndView listMyOrderHistory(@RequestParam Map<String, Object> dateMap,HttpServletRequest request, HttpServletResponse response)  throws Exception;
